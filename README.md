...
<p align="center">
  <img src="https://img.shields.io/badge/platform-Bank-blue?style=for-the-badge" />
  <img src="https://img.shields.io/badge/type-support%20repo-green?style=for-the-badge" />
  <img src="https://img.shields.io/badge/issues-welcome-brightgreen?style=for-the-badge" />
  <img src="https://img.shields.io/badge/discussions-enabled-purple?style=for-the-badge" />
...
```mermaid
flowchart LR
    A[User creates Issue] --> B[Triage & Labels]
    B --> C[Dev branch created]
    C --> D[Implementation]
    D --> E[PR & Review]
    E --> F[Merge]
    F --> G[Issue closed]
